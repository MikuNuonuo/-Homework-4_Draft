    ...
    public class Game
    {
        ...
        public bool CheckActivePlayers()
        {
            ...
            foreach (var player in players)
            {
                ...
                {
                    stayNumber++; //count bust players
                }

            }
            if (bustNumber >= numberOfPlayers - 1)
            {
                return false; //Just one reamining players or everyone bust!
            }
        ...
        public void PlayerShuffle()// page2, level2, shuffle cards for the new game
        {
